...
namespace Dnw\Game\Tests\Unit\Domain\Collection;
...
class PowerCollectionTest extends TestCase
{
    ...
    public function test_getPowerIdByPlayerId(): void
    {
        ...
        $this->assertEquals($assignedPower->powerId, $powerCollection->getPowerIdByPlayerId($assignedPower->playerId->get()));
    }
